    ...
    public partial class pk : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Docente__3214EC07AD67DE03", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Docente__IdUsuar__4F7CD00D",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Estudian__3214EC07A5EA70B8", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Estudiant__IdUsu__4CA06362",
                        column: x => x.IdUsuario,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cursos__3214EC07226FED8A", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Cursos__IdDocent__52593CB8",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Inscripci__IdCur__5535A963",
                        column: x => x.IdCurso,
                        principalTable: "Cursos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Inscripci__IdEst__5441852A",
